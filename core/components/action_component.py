...
# 已从 human/components/action/action_component.py 迁移至此
# 向后兼容导入: from human.components.action.action_component import ActionComponent, ActionType, ActionStatus
